...
@section('content')
    <div class="p-6 bg-slate-600 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-500 hover:-translate-y-1 transition-transform">
        ...
        <div>
            <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-8">
                @csrf

                <input type="text" hidden value="{{ Auth::user()->id }}"  name="user_id">

                <div>
                    <label for="title" class="block text-white bg-gray-800 p-2 rounded-md">Titre:</label><br>
                ...
                <div>
                    <label for="description" class="block text-white  bg-gray-800 p-2 rounded-md">Description:</label><br>
                ...
                <div>
                    <label for="context" class="block text-white bg-gray-800 p-2 rounded-md">Contexte:</label><br>
                ...
                <div>
                    <label for="instruction" class="block text-white  bg-gray-800 p-2 rounded-md">Instruction:</label><br>
                ...
                <div>
                    <label for="image" class="block text-white  bg-gray-800 p-2 rounded-md">Image :</label>
